...
| Does UI Automation detect useful CK controls? | `NO VERIFICADO` | Requires POC-001 on Windows. |
...
| What was the first reproducible POC? | `VERIFICADO` in this repository | POC-002 synthetic TES4 safety pipeline now passes 44 tests (initial baseline: 43). |
